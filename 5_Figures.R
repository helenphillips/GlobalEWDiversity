...
load(file.path(models, "biomass_ESApH+CHELSA.rds"))
load(file.path(models, "abundance_ESApH+CHELSA.rds.rds"))
...
habitCols <- ColourPicker(biomass$ESA)
#################################################
# 6. Figures
#################################################
### Interactions
...
# habitCols <- ColourPicker(sites_habitat$HabitatCover)
# luCols <- ColourPicker(sites_lu$LandUse)
habitCols <- ColourPicker(abundance$ESA)
#################################################
# 6. Figures
#################################################
