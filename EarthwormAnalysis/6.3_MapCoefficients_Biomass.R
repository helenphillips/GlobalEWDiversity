...
bio7 <- raster(file.path(GLs_folder, "CHELSA_bio10_12_BiomassCutScaled.tif"))
bio15 <- raster(file.path(GLs_folder, "CHELSA_bio10_15_BiomassCutScaled.tif"))

snow <- raster(file.path(GLs_folder, "Snow_newValues"))
aridity <- raster(file.path(GLs_folder, "Aridity_BiomassScaled"))
pet <- raster(file.path(GLs_folder, "PETyr_BiomassScaled"))

ph <- raster(file.path(GLs_folder,"PHIHOX_BiomassCutScaled.tif"))
clay <- raster(file.path(soil_GLs,"CLYPPT_BiomassCutScaled.tif"))
silt <- raster(file.path(soil_GLs,"SLTPPT_BiomassCutScaled.tif"))
cec <- raster(file.path(GLs_folder,"CECSOL_RichnessCutScaled.tif"))
orgC <- raster(file.path(GLs_folder,"ORCDRC_BiomassCutScaled.tif"))
