...
authors <- read.csv("C:\\Users\\hp39wasi\\WORK\\sWorm\\EarthwormAnalysis\\Authorship\\Co-Authors on the first analysis paper (Responses)_2019-03-31 - Form Responses 3.csv",encoding = "UTF-8")
...
write.csv(Alist, file = "C:\\Users\\hp39wasi\\WORK\\sWorm\\EarthwormAnalysis\\Authorship\\part1.csv", row.names = FALSE)
...
Clist = Alist
write.csv(Alist, file = "C:\\Users\\hp39wasi\\WORK\\sWorm\\EarthwormAnalysis\\Authorship\\part2.csv", row.names = FALSE)
...
Dlist = Alist
write.csv(Alist, file = "C:\\Users\\hp39wasi\\WORK\\sWorm\\EarthwormAnalysis\\Authorship\\part3.csv", row.names = FALSE)
...
write.csv(allAuthors, file = "C:\\Users\\hp39wasi\\WORK\\sWorm\\EarthwormAnalysis\\Authorship\\AllAuthors.csv", row.names = FALSE)
