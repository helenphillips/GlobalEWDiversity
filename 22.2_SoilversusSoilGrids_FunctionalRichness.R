...
print(paste("Loading the file: ", file.path(data_in, paste("sites+FGRichness_soilGrids", date, ".csv", sep = ""))))
...
save(fgrichness_model, file = file.path(data_out, "fgrichnessmodel_soilGrids.rds"))
