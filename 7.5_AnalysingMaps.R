...
for(resultRaster in c("spRFinalRaster.tif", "BiomassFinalRaster.tif", "AbundanceFinalRaster.tif", "FGRichnessFinalRaster.tif"))
{
  ...
  if(resultRaster == "AbundanceFinalRaster.tif"){results <- file.path(datafolder, "Abundance")}
  if(resultRaster == "FGRichnessFinalRaster.tif"){results <- file.path(datafolder, "FGRichness")}
  
  print(results)
  
  africa <- raster(file.path(results, "africa", resultRaster))
  if(resultRaster %in% c("spRFinalRaster.tif","FGRichnessFinalRaster.tif")){
    africa <- exp(africa)
